...
},{"./source/components/meetupCreate":157,"react":156}],2:[function(require,module,exports){
/**
...
var MeetupCreate = React.createClass({displayName: "MeetupCreate",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "createMeetup"}, 
        React.createElement("h1", null, "Create a meetup"), 
        React.createElement(MeetupForm, {onMeetupSubmit: this.handleMeetupSubmit})
      )
    );
  }
...
},{"./meetupForm":158,"react":156}],158:[function(require,module,exports){
var React = require("react")

var MeetupForm = React.createClass({displayName: "MeetupForm",
  ...
  render: function() {
    return (
      React.createElement("form", {className: "meetupForm", onSubmit: this.handleSubmit}, 
        React.createElement("input", {type: "text", placeholder: "Title", ref: "title"}), 
        React.createElement("textarea", {placeholder: "Description", ref: "description"}), 
        React.createElement("input", {type: "text", placeholder: "Place", ref: "place"}), 
        React.createElement("input", {type: "date", placeholder: "Date", ref: "date"}), 
        React.createElement("input", {type: "number", placeholder: "Duration", ref: "duration"}), 
        React.createElement("input", {type: "number", placeholder: "Capacity", ref: "capacity"}), 
